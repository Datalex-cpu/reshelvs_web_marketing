...
export function AnnouncementBar() {
  return (
    <div className="relative z-40 w-full border-b border-border bg-bg-deep/60">
      <Link
        href="#waitlist"
        className="group mx-auto flex w-full max-w-6xl items-center justify-center gap-2 px-6 py-2 text-center text-xs text-fg-muted transition-colors hover:text-fg"
      >
